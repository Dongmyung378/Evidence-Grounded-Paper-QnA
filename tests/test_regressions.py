...
from qna_fixtures import SequenceLLM, EVIDENCE, valid_korean_response
...
class RegressionTests(unittest.TestCase):
    ...
    def test_selected_runtime_policy_matches_verified_candidate(self):
        ...
        result = json.loads((Path(__file__).resolve().parents[1] / 'data/evaluation/abstention_evaluation.json').read_text(encoding='utf-8'))
        self.assertEqual(result['summary']['answerable_retention'], 0.95)
        self.assertEqual(result['summary']['holdout_refusal_rate'], 0.9)
