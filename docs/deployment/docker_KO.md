...
첫 분석에는 고정 모델 다운로드가 포함될 수 있어 몇 분이 걸릴 수 있습니다. UI는 백그라운드 분석 작업을 최대 600초 동안 기다립니다. 이후 분석은 이름 있는 모델 캐시 볼륨을 재사용하므로 일반적으로 훨씬 빠릅니다.
...
![백엔드와 UI Docker 이미지](../assets/screenshots/docker.png)
